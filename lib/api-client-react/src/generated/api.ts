 ...
 */
export const getGetNearbyVendorsUrl = () => {
  return `/api/jambites/vendors`;
};

export const getNearbyVendors = async (
  options?: RequestInit,
): Promise<Vendor[]> => {
  return customFetch<Vendor[]>(getGetNearbyVendorsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetNearbyVendorsQueryKey = () => {
  return [`/api/jambites/vendors`] as const;
};
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetNearbyVendorsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getNearbyVendors>>
  > = ({ signal }) => getNearbyVendors({ signal, ...requestOptions });
...
>(options?: {
  ...
  const queryOptions = getGetNearbyVendorsQueryOptions(options);
...
export const getGetVendorMenuUrl = (vendorId: string) => {
  return `/api/jambites/vendors/${vendorId}/menu`;
};
...
export const getVendorMenu = async (
  ...
  return customFetch<VendorMenu>(getGetVendorMenuUrl(vendorId), {
    ...options,
    method: "GET",
  });
};
...
export const getGetVendorMenuQueryKey = (vendorId: string) => {
  return [`/api/jambites/vendors/${vendorId}/menu`] as const;
};
...
export const getGetOrderUrl = (orderId: string) => {
  return `/api/jambites/orders/${orderId}`;
};
...
export const getGetOrderQueryKey = (orderId: string) => {
  return [`/api/jambites/orders/${orderId}`] as const;
};
