  ...
  return (
    <View style={styles.menuItemCard}>
      ...
      <View style={styles.menuItemRight}>
        <View style={[styles.menuItemImage, { backgroundColor: item.isVeg ? "#F0FDF4" : "#FFF5F5" }]}>
          <MaterialCommunityIcons
            name={item.category === "Medicines" ? "pill" : item.category === "Drinks" ? "cup" : "food-variant"}
            size={28}
            color={item.isVeg ? C.vegGreen : C.nonVegRed}
          />
        </View>
        {qty === 0 ? (
          ...
          <View style={styles.qtyControl}>
            <TouchableOpacity style={styles.qtyBtn} onPress={handleRemove}>
              <Feather name="minus" size={14} color={C.orange} />
            </TouchableOpacity>
            <Text style={styles.qtyText}>{qty}</Text>
            <TouchableOpacity style={styles.qtyBtn} onPress={handleAdd}>
              <Feather name="plus" size={14} color={C.orange} />
            </TouchableOpacity>
          </View>
        )}
      </View>
  ...
  if (isError || !data) {
    return (
      <View style={[styles.container, { paddingTop: topInset }]}>
        ...
        <View style={styles.centered}>
          <Feather name="alert-circle" size={48} color={C.errorRed} />
