...
const STATUS_STEPS: { key: OrderStatus; label: string; sublabel: string; icon: string }[] = [
  { key: "CONFIRMED", label: "Order Confirmed", sublabel: "Your order is being prepared", icon: "check-circle" },
  { key: "RIDER_ASSIGNED", label: "Rider Assigned", sublabel: "Rider is heading to the vendor", icon: "bike" },
  { key: "PICKED_UP", label: "Picked Up", sublabel: "Rider is heading to you!", icon: "navigation" },
  { key: "DELIVERED", label: "Delivered", sublabel: "Enjoy your order!", icon: "package" },
];
...
function StatusStep({ step, currentStatus, index }: {
  ...
  return (
    <View style={styles.stepRow}>
      ...
      {isActive && (
        <MaterialCommunityIcons name={step.icon as any} size={20} color={C.orange} />
      )}
    </View>
  );
}
    ...
    <View style={[styles.container, { paddingTop: topInset }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.helpBtn} onPress={() => router.push("/(tabs)/chat")}>
          <MaterialCommunityIcons name="robot-happy" size={22} color={C.orange} />
        </TouchableOpacity>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.mapContainer}>
          <View style={styles.mapPlaceholder}>
            <MaterialCommunityIcons name="map" size={48} color={C.textMuted} />
        ...
        {isDelivered && (
          <View style={styles.deliveredCard}>
            <View style={styles.deliveredIcon}>
              <Feather name="check-circle" size={36} color={C.successGreen} />
            </View>
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                <TouchableOpacity key={star} onPress={() => {
                  ...
                  <Feather
                    name="star"
                    size={32}
                    color={star <= rating ? C.amber : C.border}
                  />
                </TouchableOpacity>
              ))}
            </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.riderRow}>
            <View style={styles.riderAvatar}>
              <Feather name="user" size={24} color={C.orange} />
            </View>
            ...
            <TouchableOpacity style={styles.callBtn}>
              <Feather name="phone" size={18} color={C.orange} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        {status === "CONFIRMED" && (
          <TouchableOpacity style={styles.cancelBtn} onPress={handleCancel}>
            <Feather name="x-circle" size={16} color={C.errorRed} />
...
const styles = StyleSheet.create({
  ...
  deliveredCard: {
    ...
    gap: 10,
    borderWidth: 1,
    borderColor: "rgba(45,155,78,0.2)",
  },
  deliveredIcon: {
    width: 72,
    height: 72,
